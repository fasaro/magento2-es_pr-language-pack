...
composer require fasaro/magento2-es_pr-language-pack dev-master
php bin/magento setup:static-content:deploy es_PR
...
```
php bin/magento maintenance:enable
composer update fasaro/magento2-es_pr-language-pack dev-master
php bin/magento setup:static-content:deploy es_PR
php bin/magento indexer:reindex
php bin/magento cache:clean
php bin/magento cache:flush
